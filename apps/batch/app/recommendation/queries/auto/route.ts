...
import { recommendationQueriesAuto as ratelimit } from '@/lib/ratelimit'
import { redisClient } from '@/lib/redis'
import { supabaseClient } from '@/lib/supabase'

const MONITOR_SLUG = '/recommendation/queries/auto'
...
export async function POST(request: NextRequest) {
  ...
  const { success } = await ratelimit.limit('recommendation:queries:auto')
