...
import ClickVolumeChart from './click-volume-chart'
 ...
 */
export async function ClickVolumeChartServer({ searchParams }: Props) {
  ...
  return <ClickVolumeChart data={clickVolume} />
}
